...
public class Location {
  ...
  public Location id(@javax.annotation.Nonnull Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Location fish(@javax.annotation.Nonnull String fish) {
    this.fish = fish;
    return this;
  }
  ...
  public void setFish(@javax.annotation.Nonnull String fish) {
    this.fish = fish;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, location.id) &&
        Objects.equals(this.fish, location.fish) &&
        Objects.equals(this.name, location.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, fish, name);
  }
  ...
  static {
    ...
    openapiFields.add("fish");
    openapiFields.add("name");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("id");
    openapiRequiredFields.add("fish");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("fish").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `fish` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fish").toString()));
      }
